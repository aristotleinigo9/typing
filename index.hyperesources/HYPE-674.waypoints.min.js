(function() {
    ...
    (function() {
        ...
        d.prototype.checkEmpty = function() {
            ...
            a && c && (this.adapter.off(".waypoints"),
            delete f[this.key])
        }
        ;
        ...
        d.prototype.handleScroll = function() {
            ...
            for (b in c) {
                var f = c[b], e = f.newScroll > f.oldScroll ? f.forward : f.backward, d;
        ...
        d.prototype.destroy = function() {
            ...
            for (c in this.waypoints)
                for (var b in this.waypoints[c])
                    a.push(this.waypoints[c][b]);
            c = 0;
        ...
        d.prototype.refresh = function() {
            ...
            for (f in a) {
                ...
                for (d in this.waypoints[f]) {
                    ...
                    "function" === typeof h ? h = h.apply(g) : "string" === typeof h && (h = parseFloat(h),
                    -1 < g.options.offset.indexOf("%") && (h = Math.ceil(c.contextDimension * h / 100)));
                    g.triggerPoint = m + (c.contextScroll - c.contextOffset) - h;
                    k = k < c.oldScroll;
                    m = g.triggerPoint >= c.oldScroll;
                    h = k && m;
                    k = !k && !m;
                    !p && h ? (g.queueTrigger(c.backward),
                    b[g.group.id] = g.group) : !p && k ? (g.queueTrigger(c.forward),
                    b[g.group.id] = g.group) : p && c.oldScroll >= g.triggerPoint && (g.queueTrigger(c.forward),
    ...
    (function() {
        ...
        var d = window.HYPE_w_674;
        b.prototype.innerHeight = function() {
            var a = 0;
            this.element === this.element.window ? a = this.element.innerHeight : (a = this.element.clientHeight,
            this.element.getBoundingClientRect && (a = this.element.getBoundingClientRect(),
            a = a.bottom - a.top));
            return a
        }
        ;
        b.prototype.innerWidth = function() {
            var a = 0;
            this.element === this.element.window ? a = this.element.innerWidth : (a = this.element.clientWidth,
            this.element.getBoundingClientRect && (a = this.element.getBoundingClientRect(),
            a = a.right - a.left));
            return a
        }
        ...
        b.prototype.off = function(a, b) {
            ...
            var c = a.split(".")
              ...
              , c = c[1]
              , l = this.element;
            if (c && this.handlers[c] && d)
                e(l, this.handlers[c][d], b),
                this.handlers[c][d] = [];
            else if (d)
                for (var q in this.handlers)
                    e(l, this.handlers[q][d] || [], b),
                    this.handlers[q][d] = [];
            else if (c && this.handlers[c]) {
                for (var r in this.handlers[c])
                    e(l, this.handlers[c][r], b);
                this.handlers[c] = {}
            }
        }
        ;
        ...
        b.prototype.on = function(a, b) {
            ...
            (e[c] = e[c] || []).push(b);
            this.element.addEventListener(c, b)
        }
        ;
        b.prototype.outerHeight = function(a) {
            var b = this.innerHeight();
            a && this.element !== this.element.window && (a = window.getComputedStyle(this.element),
            b += parseInt(a.marginTop, 10),
            b += parseInt(a.marginBottom, 10));
            return b
        }
        ;
        b.prototype.outerWidth = function(a) {
            ...
            a && this.element !== this.element.window && (a = window.getComputedStyle(this.element),
            b += parseInt(a.marginLeft, 10),
            b += parseInt(a.marginRight, 10));
            return b
        }
        ;
    ...
    (function() {
        ...
        d.prototype.createWaypoints = function() {
            ...
            }, c = 0, d = b[this.axis].length; c < d; c++)
                this.createWaypoint(b[this.axis][c])
        }
        ;
    ...
    (function() {
        var b = [];
        null != window.HYPE_wdtl_674 && (b = window.HYPE_wdtl_674.slice(0));
        window.HYPE_wdtl_674 = null;
